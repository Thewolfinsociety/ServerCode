...
def BomList2CalcList(bomlist, calclist,workflowlist,mBDXMLList,gBGHash, is_new_calcitem=True):
    ...
    for i in range(0,len(bomlist)):
        ...
        log.info('i='+str(i)+'item.m='+str()+','+'p.m=' + str(pnumber(m3[0][0])) + ',' + str(pnumber(m3[0][1])) + ',' + str(pnumber(m3[0][2])) + ',' + str(
                pnumber(m3[0][3])) + ',' \
        ...
        for i in range(0, 101):
            ...
            if p.ahole_index[i] == -1:
                ...
                with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                    f.write('AddHoleSelf_A=' + str(len(mHPInfoList))+'\n')
                hpinfo.x = x
                hpinfo.y = y
                hpinfo.xx = 0
                hpinfo.yy = 0
    ...
    def AddOneHole(x, y, hd, holetype, face, rb, rv, rh, hc):
        for i in range(0,101):
            if p.bhole_index[i] == -1:
                ...
                mHPInfoList.append(hpinfo)
                with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                    f.write('AddHoleSelf_B=' + str(len(mHPInfoList))+'\n')
                hpinfo.x = x
                hpinfo.y = y
                hpinfo.xx = 0
                hpinfo.yy = 0
    ...
    (IsLSIntersection(p1.y + p1.bg_l_minx, p1.y + p1.bg_l_maxx, p2.y + p2.bg_r_minx, p2.y + p2.bg_r_maxx)==1):
        ...
        for i in range(0,len(p1.bhpt)):
            ...
            if bhp.hdirect == 'L':
                ...
                if (bhp.sri != '') and (bhp.sri!='0') :
                    with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                        f.write('CalcBdxmlHole_LeftFaceAddHole_B'+'Left1')
                ...
                for j in range(1,bhp.holenum_y):
                    ...
                    if (bhp.sri != '') and bhp.sri !='0':
                        with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                            f.write('CalcBdxmlHole_LeftFaceAddHole_B' + 'Left2')
            ...
            if bhp.hdirect =='L':
                ...
                if (bhp.sri != '') and (bhp.sri != '0') :
                    AddHole_B(None, p2, p1, ho, IdentityHmgMatrix, y, x, 0, -1, 0,
                              bhp.hole_z, 0, 'Left', 'I', bhp.sri, '', '')
                    with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                        f.write('CalcBdxmlHole_LeftFaceAddHole_B' + 'Left3')
                for j in range(1,bhp.holenum_y):
                    p2.big_p = p1
                    ho.wz = int(bhp.y) + bhp.hole_ycap * j
                    if (bhp.sri != '') and (bhp.sri != '0') :
                        with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                            f.write('CalcBdxmlHole_LeftFaceAddHole_B' + 'Left4')
...
def AddOffsetIHole_A(c, p, p2, ho, x, y, hd, holeid, offset, smallcap, holecap, face, holetype, hole, sr, sri, \
    ...
    for i in range(0,101):
        if p2.ahole_index[i] == -1:
            ...
            mHPInfoList.append(hpinfo)
            with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                f.write('AddOffsetIHole_AmHPInfoList1=' + str(len(mHPInfoList))+'\n')
            ...
            hpinfo.b_bh = Delphi_Round(p.bh)
            with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                f.write('AddOffsetIHole_AmHPInfoList1=' + 'x=' + str(pnumber(hpinfo.x)) + ',y=' + str(pnumber(hpinfo.y)) + ',xx=' + str(hpinfo.xx)
                        + ',yy=' + str(hpinfo.yy) + ',hd=' + str(hpinfo.hd) + ',hpinfo.r=' + str(
                    hpinfo.r) + ',sri=' + str(hpinfo.sri)
                        + ',htype=' + hpinfo.htype + ',holeid=' + str(hpinfo.holeid) + ',row=' + str(hpinfo.row)
                        + ',offset=' + str(hpinfo.offset) + ',face=' + str(hpinfo.face) + ',sr=' + str(
    ...
    if (c != None) and (mx_flag>=0) and c.mx_isoutput ==1:
        ...
        for i in range(0,101):
            if p2.ahole_index[i] == -1:
                ...
                mHPInfoList.append(hpinfo)
                with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                    f.write('AddOffsetIHole_AmHPInfoList2=' + str(len(mHPInfoList))+'\n')
...
def AddOffsetIHole_B(c, p, p2, ho, x, y, hd, holeid, offset, smallcap, holecap, face, holetype, hole, sr, sri, \
    ...
    for i in range(0,101):
        if p2.bhole_index[i] == -1:
            ...
            mHPInfoList.append(hpinfo)
            with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                f.write('AddOffsetIHole_B1=' + str(len(mHPInfoList))+'\n')
    ...
    if (c != None) and (mx_flag>=0) and c.mx_isoutput ==1:
        ...
        for i in range(0,101):
            if p2.bhole_index[i] == -1:
                ...
                mHPInfoList.append(hpinfo)
                with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                    f.write('AddOffsetIHole_B2=' + str(len(mHPInfoList))+'\n')
...
def AddIHole2_A(c, p, p2, ho, tm, x, y, hd, holeid, offset, smallcap, holecap,
    ...
    with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
        f.write(
            ...
            + str(pnumber(tm[3][0])) + ',' + str(pnumber(tm[3][1])) + ',' + str(pnumber(tm[3][2])) + ',' + str(
                pnumber(tm[3][3])) + '\n')
    with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
        f.write('v1=' + str(pnumber(v[0])) + ',' + str(pnumber(v[1])) + ',' + str(pnumber(v[2])) + '\n')
    ...
    with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
        f.write('v2=' + str(pnumber(v[0])) + ',' + str(pnumber(v[1])) + ',' + str(pnumber(v[2])) + '\n')
    with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
        f.write(
    ...
    with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
        f.write('v3=' + str(pnumber(v[0])) + ',' + str(pnumber(v[1])) + ',' + str(pnumber(v[2])) + '\n')
    ...
    yy = 0
    with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
        f.write('op.direct=' + str(op.direct) +'v0='+str(v[0])+'v1='+str(v[1])+'v2='+str(v[2])+'\n')
    ...
    if op.direct in [2, 3]: #背板
        ...
        t = Delphi_Round(v[1])
    with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
        f.write('x=' + str(x)+'xx=' + str(xx)+'y=' + str(y)+'yy=' + str(yy)+'t='+str(t) +'\n')
    for i in range(0,101):
        ...
        if hole_index == -1 :
            ...
            mHPInfoList.append(hpinfo)
            with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                f.write('AddIHole2_A1=' + str(len(mHPInfoList))+',t1='+str(int(t))+'\n')
            ...
            with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                f.write('AddIHole2_A1=' + 'x=' + str(pnumber(hpinfo.x)) + ',y=' + str(pnumber(hpinfo.y))+',xx='+str(hpinfo.xx)
    ...
    if (c != None) and (mx_flag>=0) and c.mx_isoutput ==1:
        ...
        for i in range(0, 101):
            ...
            if hole_index == -1:
                ...
                mHPInfoList.append(hpinfo)
                with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                    f.write('AddIHole2_A2=' + str(len(mHPInfoList))+',t2='+str(int(t))+'\n')
                ...
                hpinfo.b_bh = Delphi_Round(p2.bh)
                with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                    f.write('AddIHole2_A2=' + 'x=' + str(pnumber(hpinfo.x)) + ',y=' + str(pnumber(hpinfo.y)) + ',xx=' + str(hpinfo.xx)
                            + ',yy=' + str(hpinfo.yy) + ',hd=' + str(hpinfo.hd) + ',hpinfo.r=' + str(
                        hpinfo.r) + ',sri=' + str(hpinfo.sri)
                            + ',htype=' + hpinfo.htype + ',holeid=' + str(hpinfo.holeid) + ',row=' + str(hpinfo.row)
                            + ',offset=' + str(hpinfo.offset) + ',face=' + str(hpinfo.face) + ',sr=' + str(
...
def AddIHole2_B(c, p, p2, ho, tm, x, y, hd, holeid, offset, smallcap, holecap,
    ...
    #计算旋转的板件
    with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
        f.write('p2.xptlist_jx'+str(p2.xptlist_jx) +'\n')
    if p2.xptlist_jx in [3,4]:
        angle = p2.var_args[0]
        m = IdentityHmgMatrix
        if (p2.xptlist_pl==1) and (p2.xptlist_jx==3) :
        ...
        m2 = MatrixMultiply(p2.m, tm)
    with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
        f.write('v1='+str(int(v[0]))+','+str(int(v[1]))+','+str(int(v[2]))+ '\n')
    #print 'v1=',v,type(m2)
    m3 = m2.tolist()
    # with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
    #     f.write('m2='+str(int(m3[0][0]))+','+str(int(m3[0][1]))+','+str(int(m3[0][2]))+','+str(int(m3[0][3]))+','\
    ...
    with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
        f.write('m2='+str((m3[0][0]))+','+str((m3[0][1]))+','+str((m3[0][2]))+','+str((m3[0][3]))+','\
    ...
    with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
        f.write('v2=' + str(pnumber(v[0])) + ',' + str(pnumber(v[1])) + ',' + str(pnumber(v[2])) + '\n')
    with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
        f.write('p.m='+str(pnumber(m3[0][0]))+','+str(pnumber(m3[0][1]))+','+str(pnumber(m3[0][2]))+','+str(pnumber(m3[0][3]))+','\
    ...
    for i in range(0,101):
        ...
        if hole_index == -1:
            ...
            with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                f.write('AddIHole2_B1='+str(len(mHPInfoList))+',t1='+str(int(t))+'\n')
            hpinfo.x = x
            hpinfo.y = y
            hpinfo.xx = pnumber(xx)
            hpinfo.yy = pnumber(yy)
            ...
            hpinfo.b_bh = Delphi_Round(p2.bh)
            with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                f.write('AddIHole2_B1=' + 'x=' + str(pnumber(hpinfo.x)) + ',y=' + str(pnumber(hpinfo.y))+',xx='+str(hpinfo.xx)
                        +',yy='+str(hpinfo.yy)+',hd='+str(hpinfo.hd)+',hpinfo.r='+str(hpinfo.r)+',sri='+str(hpinfo.sri)
                        +',htype='+hpinfo.htype+',holeid='+str(hpinfo.holeid)+',row='+str(hpinfo.row)
                        +',offset='+str(hpinfo.offset)+',face='+str(hpinfo.face)+',sr='+str(sr)+',smallcap='+str(smallcap)
                        +',holecap='+str(hpinfo.holecap)+',isii='+str(hpinfo.isii)+
    ...
    if (c != None) and (mx_flag>=0) and c.mx_isoutput ==1:
        ...
        for i in range(0, 101):
            ...
            if hole_index == -1:
                ...
                mHPInfoList.append(hpinfo)
                with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                    f.write('AddIHole2_B2=' + str(len(mHPInfoList))+',t2='+str(int(t))+'\n')
                ...
                hpinfo.b_bh = Delphi_Round(p2.bh)
                with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                    f.write('AddIHole2_B2=' + 'x=' + str(pnumber(hpinfo.x)) + ',y=' + str(pnumber(hpinfo.y)) + ',xx=' + str(hpinfo.xx)
                            + ',yy=' + str(hpinfo.yy) + ',hd=' + str(hpinfo.hd) + ',hpinfo.r=' + str(
                        hpinfo.r) + ',sri=' + str(hpinfo.sri)
                            + ',htype=' + hpinfo.htype + ',holeid=' + str(hpinfo.holeid) + ',row=' + str(hpinfo.row)
                            + ',offset=' + str(hpinfo.offset) + ',face=' + str(hpinfo.face) + ',sr=' + str(
...
def AddLHole_A(c, p, p2, x, y, hd, holeid, offset, smallcap, holecap,
    ...
    for i in range(0,101):
        if p.ahole_index[i] == -1:
            ...
            mHPInfoList.append(hpinfo)
            with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                f.write('AddLHole_A1='+str(len(mHPInfoList))+'\n')
            ...
            hpinfo.b_bh = Delphi_Round(p2.bh)
            with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                f.write('AddLHole_A1=' + 'x=' + str(pnumber(hpinfo.x)) + ',y=' + str(pnumber(hpinfo.y)) + ',xx=' + str(hpinfo.xx)
                        + ',yy=' + str(hpinfo.yy) + ',hd=' + str(hpinfo.hd) + ',hpinfo.r=' + str(
                    hpinfo.r) + ',sri=' + str(hpinfo.sri)
                        + ',htype=' + hpinfo.htype + ',holeid=' + str(hpinfo.holeid) + ',row=' + str(hpinfo.row)
                        + ',offset=' + str(hpinfo.offset) + ',face=' + str(hpinfo.face) + ',sr=' + str(
    ...
    if (c != None) and (mx_flag>=0) and c.mx_isoutput ==1:
        ...
        for i in range(0,101):
            if p.ahole_index[i] == -1:
                ...
                with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                    f.write('AddLHole_A2=' + str(len(mHPInfoList))+'\n')
                if c!= None and c.b_isoffset == 1 and holetype == 'L':
                    mTmpExp['$SL'] = str(p.gl)
                    mTmpExp['$SD'] = str(p.gp)
                    mTmpExp['$SH'] = str(p.gh)
                ...
                hpinfo.b_bh = Delphi_Round(p2.bh)
                with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                    f.write('AddLHole_A2=' + 'x=' + str(pnumber(hpinfo.x)) + ',y=' + str(pnumber(hpinfo.y)) + ',xx=' + str(hpinfo.xx)
                            + ',yy=' + str(hpinfo.yy) + ',hd=' + str(hpinfo.hd) + ',hpinfo.r=' + str(
                        hpinfo.r) + ',sri=' + str(hpinfo.sri)
                            + ',htype=' + hpinfo.htype + ',holeid=' + str(hpinfo.holeid) + ',row=' + str(hpinfo.row)
                            + ',offset=' + str(hpinfo.offset) + ',face=' + str(hpinfo.face) + ',sr=' + str(
...
def AddLHole_B(c, p, p2, x, y, hd, holeid, offset, smallcap, holecap,
    ...
    for i in range(0,101):
        ...
        if p.bhole_index[i] == -1:
            ...
            mHPInfoList.append(hpinfo)
            with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                f.write('AddLHole_B1=' + str(len(mHPInfoList))+'\n')
            print('AddLHole_B1:', len(mHPInfoList))
            if (c!=None) and c.b_isoffset ==1 and holetype=='L':
                mTmpExp['$SL'] =  str(p.gl)
                mTmpExp['$SD'] =  str(p.gp)
                mTmpExp['$SH'] = str(p.gh)
            ...
            hpinfo.b_bh = Delphi_Round(p2.bh)
            with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                f.write('AddLHole_B1=' + 'x=' + str(pnumber(hpinfo.x)) + ',y=' + str(pnumber(hpinfo.y)) + ',xx=' + str(hpinfo.xx)
                        + ',yy=' + str(hpinfo.yy) + ',hd=' + str(hpinfo.hd) + ',hpinfo.r=' + str(
                    hpinfo.r) + ',sri=' + str(hpinfo.sri)
                        + ',htype=' + hpinfo.htype + ',holeid=' + str(hpinfo.holeid) + ',row=' + str(hpinfo.row)
                        + ',offset=' + str(hpinfo.offset) + ',face=' + str(hpinfo.face) + ',sr=' + str(
    ...
    if (c != None) and (mx_flag>=0) and c.mx_isoutput ==1:
        ...
        for i in range(0,101):
            if p.bhole_index[i] == -1:
                ...
                mHPInfoList.append(hpinfo)
                with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                    f.write('AddLHole_B2=' + str(len(mHPInfoList))+'\n')
                print('mHPInfoListAddLHole_B2:',len(mHPInfoList))
                if c!= None and c.b_isoffset == 1 and holetype == 'L':
                    mTmpExp['$SL'] = str(p.gl)
                    mTmpExp['$SD'] = str(p.gp)
                    mTmpExp['$SH'] = str(p.gh)
                ...
                hpinfo.b_bh = Delphi_Round(p2.bh)
                with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                    f.write('AddLHole_B2=' + 'x=' + str(pnumber(hpinfo.x)) + ',y=' + str(pnumber(hpinfo.y)) + ',xx=' + str(hpinfo.xx)
                            + ',yy=' + str(hpinfo.yy) + ',hd=' + str(hpinfo.hd) + ',hpinfo.r=' + str(
                        hpinfo.r) + ',sri=' + str(hpinfo.sri)
                            + ',htype=' + hpinfo.htype + ',holeid=' + str(hpinfo.holeid) + ',row=' + str(hpinfo.row)
                            + ',offset=' + str(hpinfo.offset) + ',face=' + str(hpinfo.face) + ',sr=' + str(
...
def CalcHoleUnit_CalcHoleList(listEx, mIIHoleCalcRule):
    ...
    for i in range(0, len(listEx)):
        ...
        for j in range(0, len(listEx)):
            ...
            #print p1.guid
            #print 'p1.holeid:', p1.holeid, 'p2.holeid:', p2.holeid, 'name=', p1.name,p1.bl, p1.bp, p1.bh,'p1.x=',p1.x,'p1.y=',p1.y,'p1.z=',p1.z,'p1.m=', p1.m, p1.v,'p1.space_id=',p1.space_id
            #print  'p2=', p2.name,'p2.x=',p2.x,'p2.y=',p2.y,'p2.z=',p2.z,  p2.bl, p2.bp, p2.bh,'p2.m=', p2.m, p2.v,'p2.space_id=',p2.space_id
            if (IsNoCalc(p2) > 1) or (p1.space_id != p2.space_id) or (p1.sozflag != p2.sozflag): continue
            p1, p2 = SubSpaceAItem(p1, p2, mCItem1, mCItem2)
            # // di值0和1可以认为等价，为避免xml模块忘记写纹路
            ## 'self_p=', p1.self_p
            ...
            #     print 'p1.holeid:', p1.holeid, 'p2.holeid:', p2.holeid, 'name=', p1.name,p1.bl, p1.bp, p1.bh,'p1.x=',p1.x,'p1.y=',p1.y,'p1.z=',p1.z,'p1.m=', p1.m, p1.v,
    ...
    for i in range(0,len(listEx)):
        ...
        for j in range(0,len(root)):
            ...
            if n=='0' :
                with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                    f.write(('AddHoleSelf_A='+str(len(mHPInfoList))+'i='+str(i)+'j='+str(j)).decode('utf8').encode('gbk')+
            ...
            if n=='1' :
                with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                    f.write(('AddHoleSelf_B=' + str(len(mHPInfoList)) + 'i=' + str(i) + 'j=' + str(j)).decode(
                    'utf8').encode('gbk')+
                            'gl='+str(p1.gl)+'gp='+str(p1.gp)+'gh='+str(p1.gh)+'\n')
    ...
    for i in range(0,len(listEx)):
        ...
        for j in range(0,len(listEx)):
            ...
            if (abs(p1.x - p2.x - PCI_GL(p2)) < 2) : #// 左面
                ...
                with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                    f.write(('C左面mHPInfoList='+str(len(mHPInfoList))+'i='+str(i)+'j='+str(j)+'\n').decode('utf8').encode('gbk'))
            if (abs(p1.x + PCI_GL(p1) - p2.x) < 2) : #// 右面
                CalcBdxmlHole_RightFace(p1, p2)
                with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                    f.write(('C右面mHPInfoList='+str(len(mHPInfoList))+'i='+str(i)+'j='+str(j)+'\n').decode('utf8').encode('gbk'))
            if (abs(p1.z - p2.z - p2.gh) < 2) : #// 下面
                CalcBdxmlHole_DownFace(p1, p2)
                with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                    f.write(('C下面mHPInfoList='+str(len(mHPInfoList))+'i='+str(i)+'j='+str(j)+'\n').decode('utf8').encode('gbk'))
            if (abs(p1.z + p1.gh - p2.z) < 2) : #// 上面
                CalcBdxmlHole_UpFace(p1, p2)
                with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                    f.write(('C上面mHPInfoList='+str(len(mHPInfoList))+'i='+str(i)+'j='+str(j)+'\n').decode('utf8').encode('gbk'))
            if (abs(p1.y - p2.gp - p2.y) < 2) : #// 后面
                CalcBdxmlHole_BackFace(p1, p2)
                with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                    f.write(('C后面mHPInfoList='+str(len(mHPInfoList))+'i='+str(i)+'j='+str(j)+'\n').decode('utf8').encode('gbk'))

            if (abs(p1.y + p1.gp - p2.y) < 2) : #// 前面
                CalcBdxmlHole_FrontFace(p1, p2)
                with open(base_dir + '\\testdata\\' + 'mHPInfoList' + '.txt', 'a+') as f:
                    f.write(('C前面mHPInfoList='+str(len(mHPInfoList))+'i='+str(i)+'j='+str(j)+'\n').decode('utf8').encode('gbk'))
            UpdateCalcItemResult(listEx[i], mCItem1)
            UpdateCalcItemResult(listEx[j], mCItem2)
        ...
        for j in range(0,len(listKc)):
            ...
            if (p1.x < p2.x + p2.gl) and (p1.x > p2.x) and (p1.kcid >= 0) : #// 左面
                ...
                with open(base_dir + '\\testdata\\' + 'mKCInfoList' + '.txt', 'a+') as f:
                    f.write(('j='+str(j)+'左面mKCInfoList='+str(len(mKCInfoList))+'\n').decode('utf8').encode('gbk'))
            ...
            if (p1.x + p1.gl < p2.x + p2.gl) and (p1.x + p1.gl > p2.x) and (p1.kcid >= 0) : #// 右面
                ...
                with open(base_dir + '\\testdata\\' + 'mKCInfoList' + '.txt', 'a+') as f:
                    f.write(('j='+str(j)+'右面mKCInfoList='+str(len(mKCInfoList))+'\n').decode('utf8').encode('gbk'))
            ...
            if (p1.z < p2.z + p2.gh) and (p1.z > p2.z) and (p1.kcid >= 0) : #// 下面
                ...
                with open(base_dir + '\\testdata\\' + 'mKCInfoList' + '.txt', 'a+') as f:
                    f.write(('j='+str(j)+'下面mKCInfoList='+str(len(mKCInfoList))+'\n').decode('utf8').encode('gbk'))
            ...
            if (p1.z + p1.gh < p2.z + p2.gh) and (p1.z + p1.gh > p2.z) and (p1.kcid >= 0) : #// 上面
                ...
                with open(base_dir + '\\testdata\\' + 'mKCInfoList' + '.txt', 'a+') as f:
                    f.write(('j='+str(j)+'上面mKCInfoList='+str(len(mKCInfoList))+'\n').decode('utf8').encode('gbk'))
            ...
            if (p1.y < p2.y + p2.gp) and (p1.y > p2.y) and (p1.kcid >= 0) : #// 后面
                ...
                with open(base_dir + '\\testdata\\' + 'mKCInfoList' + '.txt', 'a+') as f:
                    f.write(('j='+str(j)+'后面mKCInfoList='+str(len(mKCInfoList))+'\n').decode('utf8').encode('gbk'))
            ...
            if (p1.y + p1.gp < p2.y + p2.gp) and (p1.y + p1.gp > p2.y) and (p1.kcid >= 0) : #// 前面
                ...
                with open(base_dir + '\\testdata\\' + 'mKCInfoList' + '.txt', 'a+') as f:
                    f.write(('j='+str(j)+'前面mKCInfoList='+str(len(mKCInfoList))+'\n').decode('utf8').encode('gbk'))
