...
def GetTrueFalse(string):
    if(string == 'TRUE' or string == 'True'or string == True or string == 1):
        ...
        return False
def InitData():
    global SlidingExp,SlidingType,SlidingParam,UDBoxParam,TrackParam,\
        HBoxParam,mVBoxParamList,mPanelBomDetailList,mSSExpList, \
    ...
    try:
        mNoFZTPriceFlag = cf.get("QuickDraw".encode('gb2312'), "NoFZTPriceFlag".encode('gb2312'))
    except:
        mNoFZTPriceFlag = 1
    try:
        mNoCDWPriceFlag = cf.get("QuickDraw".encode('gb2312'), "NoCDWPriceFlag".encode('gb2312'))
    except:
        mNoCDWPriceFlag = 0
    try:
        mBomPriceFlag = cf.get("QuickDraw".encode('gb2312'), "BomPriceFlag".encode('gb2312'))
    except:
        mBomPriceFlag = 0
    #print 'mNoFZTPriceFlag=',mNoFZTPriceFlag,'mNoCDWPriceFlag=',mNoCDWPriceFlag,'mBomPriceFlag=',mBomPriceFlag
    cf1 = copyini(RootPath + '\\QdCloud\\Sliding.ini')
    try:
    ...
    #-------------------cfg
    try:
        with open(RootPath + '\\QdCloud\\Sliding\\趟门配置表\\单门数量类型.cfg'.encode('gb2312'),'r') as f:
    ...
    try:
        with open(RootPath + '\\QdCloud\\Sliding\\趟门配置表\\门类型.cfg'.encode('gb2312'),'r') as f:
        ...
        SlidingTypecontent = json.dumps([])
    try:
        with open(RootPath + '\\QdCloud\\Sliding\\趟门配置表\\趟门参数.cfg'.encode('gb2312'),'r') as f:
        ...
        SlidingParamcontent = json.dumps([])
    try:
        with open(RootPath + '\\QdCloud\\Sliding\\趟门配置表\\上下横框参数.cfg'.encode('gb2312'),'r') as f:
        ...
        UDBoxParamcontent = json.dumps([])
    try:
        with open(RootPath + '\\QdCloud\\Sliding\\趟门配置表\\上下轨参数.cfg'.encode('gb2312'),'r') as f:
        ...
        TrackParamcontent = json.dumps([])
    try:
        with open(RootPath + '\\QdCloud\\Sliding\\趟门配置表\\中横框参数.cfg'.encode('gb2312'),'r') as f:
        ...
        HBoxParamcontent = json.dumps([])
    try:
        with open(RootPath + '\\QdCloud\\Sliding\\趟门配置表\\门板类型.cfg'.encode('gb2312'),'r') as f:
        ...
        PanelTypeListcontent = json.dumps([])
    try:
        with open(RootPath + '\\QdCloud\\Sliding\\趟门配置表\\报价.cfg'.encode('gb2312'),'r') as f:
        ...
        mSlidingPriceListcontent = json.dumps([])
    try:
        with open(RootPath + '\\QdCloud\\Sliding\\趟门配置表\\报价方案.cfg'.encode('gb2312'),'r') as f:
        ...
        mPriceTableListcontent = json.dumps([])
    try:
        with open(RootPath + '\\QdCloud\\Sliding\\趟门配置表\\颜色分类2.cfg'.encode('gb2312'),'r') as f:
        ...
        mSlidingColorListcontent = json.dumps([])
    try:
        with open(RootPath + '\\QdCloud\\Sliding\\趟门配置表\\颜色分类.cfg'.encode('gb2312'),'r') as f:
        ...
        mSlidingColorClassListcontent = json.dumps([])
    try:
        with open(RootPath + '\\QdCloud\\Sliding\\趟门配置表\\五金配件分类数据.cfg'.encode('gb2312'),'r') as f:
        ...
        mSlidingWjBomDetailListcontent = json.dumps([])
    try:
        with open(RootPath + '\\QdCloud\\Sliding\\趟门配置表\\百叶板计算公式.cfg'.encode('gb2312'),'r') as f:
        ...
        mSSExpListcontent = json.dumps([])
    try:
        with open(RootPath + '\\QdCloud\\Sliding\\趟门配置表\\五金配件.cfg'.encode('gb2312'),'r') as f:
        ...
        mSlidingAccessoryListcontent = json.dumps([])
    try:
        with open(RootPath + '\\QdCloud\\Sliding\\趟门配置表\\竖框参数.cfg'.encode('gb2312'),'r') as f:
        ...
        mVBoxParamListcontent = json.dumps([])
    try:
        with open(RootPath + '\\QdCloud\\Sliding\\趟门配置表\\门板附加物料.cfg'.encode('gb2312'),'r') as f:
        ...
        mPanelBomDetailListcontent = json.dumps([])
    try:
        with open(RootPath + '\\QdCloud\\Sliding\\趟门配置表\\竖中横框参数.cfg'.encode('gb2312'),'r') as f:
        ...
        UHBoxParamcontent = json.dumps([])
    try:
        with open(RootPath + '\\QdCloud\\Sliding\\趟门配置表\\横中横框参数.cfg'.encode('gb2312'),'r') as f:
        ...
        HHBoxParamcontent = json.dumps([])
    try:
        with open(RootPath + '\\QdCloud\\Sliding\\趟门配置表\\趟门2竖分格.cfg'.encode('gb2312'),'r') as f:
        ...
        Cfgobj2content = json.dumps([])
    try:
        with open(RootPath + '\\QdCloud\\Sliding\\趟门配置表\\趟门3竖分格.cfg'.encode('gb2312'),'r') as f:
        ...
        Cfgobj3content = json.dumps([])
    try:
        with open(RootPath + '\\QdCloud\\Sliding\\趟门配置表\\趟门4竖分格.cfg'.encode('gb2312'),'r') as f:
    ...
    try:
        ...
        SHBoxParamcontent = json.dumps([])
    try:
        with open(RootPath + '\\QdCloud\\Sliding\\趟门配置表\\趟门2横分格.cfg'.encode('gb2312'),'r') as f:
        ...
        HCfgobj2content = json.dumps([])
    try:
        with open(RootPath + '\\QdCloud\\Sliding\\趟门配置表\\趟门3横分格.cfg'.encode('gb2312'),'r') as f:
        ...
        HCfgobj3content = json.dumps([])
    try:
        with open(RootPath + '\\QdCloud\\Sliding\\趟门配置表\\趟门4横分格.cfg'.encode('gb2312'),'r') as f:
    ...
    try:
        ...
        HSHBoxParamcontent = json.dumps([])
    try:
        with open(RootPath + '\\data\\QdData\\门转换表.cfg'.encode('gb2312'),'r') as f:
            cfglistcontent=f.read()
        if cfglistcontent=='':
            cfglistcontent = json.dumps([])
    except:
        cfglistcontent = json.dumps([])
    SlidingExp = json.loads(SlidingExpcontent,encoding='gbk')
    SlidingType = json.loads(SlidingTypecontent,encoding='gbk')
    SlidingParam = json.loads(SlidingParamcontent,encoding='gbk')
    UDBoxParam = json.loads(UDBoxParamcontent,encoding='gbk')
    TrackParam = json.loads(TrackParamcontent,encoding='gbk')
    HBoxParam = json.loads(HBoxParamcontent,encoding='gbk')
    ...
    sSort(HCfgobj3)
    sSort(HCfgobj4)
    for i in range(0,len(SlidingExp)):
        SlidingExp[i]['doornum'] = Number(SlidingExp[i]['doornum'])
        SlidingExp[i]['overlapnum'] = Number(SlidingExp[i]['overlapnum'])
        SlidingExp[i]['lkvalue'] = Number(SlidingExp[i]['lkvalue'])
        ...
        SlidingExp[i]['noexp'] = GetTrueFalse(SlidingExp[i]['noexp'])# // SlidingExp[i].noexp == 'TRUE'? true:false;
    ...
    for i in range(0, len(SlidingParam)):
        SlidingParam[i]["ddlw"] = Number(SlidingParam[i]['ddlpos'])
        SlidingParam[i]["fztlen"] = Number(SlidingParam[i]['fztkd'])
        SlidingParam[i]["myclass"] = SlidingParam[i]['doortype']
        SlidingParam[i]['cpm_lmax'] = Number(SlidingParam[i]['cpm_lmax'])
        SlidingParam[i]['cpm_hmax'] = Number(SlidingParam[i]['cpm_hmax'])
        SlidingParam[i]['is_xq'] = GetTrueFalse(SlidingParam[i]['is_xq'])
        SlidingParam[i]['hboxvalue'] = Number(SlidingParam[i]['hboxvalue'])
        SlidingParam[i]['laminating'] = GetTrueFalse(SlidingParam[i]['laminating'])
    ...
    for i in range(0,len(UDBoxParam)):
        UDBoxParam[i]["ubheight"] = Number(UDBoxParam[i]['upboxheight'])
        UDBoxParam[i]["ubdepth"] = Number(UDBoxParam[i]['upboxdepth'])
        UDBoxParam[i]["ubthick"] = Number(UDBoxParam[i]['upboxthick'])
        UDBoxParam[i]["dbheight"] = Number(UDBoxParam[i]['downboxheight'])
        UDBoxParam[i]["dbdepth"] = Number(UDBoxParam[i]['downboxdepth'])
        UDBoxParam[i]["dbthick"] = Number(UDBoxParam[i]['downboxthick'])
        UDBoxParam[i]["uphole"] = Number(UDBoxParam[i]['upholepos'])
        UDBoxParam[i]["downhole"] = Number(UDBoxParam[i]['downholepos'])
        UDBoxParam[i]["upsize"] = Number(UDBoxParam[i]['upsize'])
    for i in range(0, len(HBoxParam)):
        HBoxParam[i]["hole"] = Number(HBoxParam[i]['holepos'])
        HBoxParam[i]["ishboxvalue"] = Number(HBoxParam[i]['ishboxvalue'])
...
def LoadXMLTemplate(xml, l, h):
    ...
    if state==-1:
        return ''
    xmltemplate = p.value.encode('utf8')
    ...
    pexp = GetParam(SlidingExp,attri)    #
    attri = root.get('门类型', '')
    pstype = GetParam(SlidingType, attri)
    attri = root.get('边框类型', '')
    psp = GetParam(SlidingParam, attri)  #趟门参数.cfg'
    attri = root.get('上下横框类型', '')
    pudbox = GetParam(UDBoxParam, attri)
    attri = root.get('上下轨类型', '')
    ptrack = GetParam(TrackParam, attri)
    attri = root.get('中横框类型', '')
    phbox = GetParam(HBoxParam, attri)
    if psp != {}:
...
def XmlTemplate2Json(Templatexml, l, h):
    ...
    nHasMzhb = False
    mSlidingParam = {'name': ''}
    if os.path.exists(RootPath + '\\data\\QdData\\门转换表.cfg'):
        with open(RootPath + '\\data\\QdData\\门转换表.cfg') as f:
             string = f.read()
...
def GetSlidingColorClass(*argv):
    if len(argv) == 3:
        ...
        clor = argv[2]
        Result = {}
        for i in range(0,len(aTablevalue['颜色分类.cfg'])):
            if ((aTablevalue['颜色分类.cfg'][i]['myclass'] == styp) and (aTablevalue['颜色分类.cfg'][i]['mat'] == stype2) and
            ((clor == aTablevalue['颜色分类.cfg'][i]['color']))):
                Result = aTablevalue['颜色分类.cfg'][i]
                break
        return Result
    if len(argv) == 2:
        myclass = argv[0]
        ...
        Result = {}
        for i in range(0, len(aTablevalue['颜色分类.cfg'])):
            if ((aTablevalue['颜色分类.cfg'][i]['myclass'] == myclass) and
                    ((color != '') or (color == aTablevalue['颜色分类.cfg'][i]['color']))):
                Result = aTablevalue['颜色分类.cfg'][i]
                break
        return Result
def GetAccessory(name):
    Result = {}
    for k in range(0,len(aTablevalue["五金配件.cfg"])):
        if(aTablevalue["五金配件.cfg"][k]['name'] == name):
            Result = aTablevalue["五金配件.cfg"][k]
            break
    return Result
def NewWLData():
    pwl={}
...
def addBox(rb, door, i, nType=False):
    ...
    phbox = {}
    if (not nType):
        phbox = findName(rb['类型'], aTablevalue['中横框参数.cfg'])
    elif (nType == 1):
        phbox = findName(rb['类型'], aTablevalue['竖中横框参数.cfg'])
    elif (nType == 2):
        phbox = findName(rb['类型'], aTablevalue['横中横框参数.cfg'])
    else:
        pass
    if (phbox):
        pwl['memo'] = phbox['memo']
...
def ResetMxSize(mGrid, PanelIndex, fg, FGObj, Jsonvar, mUDBoxParam, mVBoxParam):
    ...
    subss1 = ''
    ss1 = FGObj['CurcfgObj']['门芯列表2'][fg]['名称']
    nIndex =0 if ss1[len(ss1) - 1:] =='' else float(ss1[len(ss1) - 1:])
    hbox = FGObj['cSBoxp']
    # // 上横插槽值
...
def GetXMLBom(xml):
    ...
    aTablevalue["中横框参数.cfg"] = HBoxParam
    ...
    for i in range(0, len(ALLlist)):
        ...
        if (nHasMzhb):
            ...
            newpw2['Unit'] = myUi['单位']
        list2.append(newpw2)
    log.info('len of list2='+str(len(list2)))
    return list2
