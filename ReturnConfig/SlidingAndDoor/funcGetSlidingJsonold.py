...
def GetXMLBom(xml):
    ...
    aTablevalue[u"上下轨参数.cfg"] = mTrackParamList
    aTablevalue[u"上下横框参数.cfg"] = mUDBoxParamList
    aTablevalue[u"竖框参数.cfg"] = mVBoxParamList
    aTablevalue[u"竖中横框参数.cfg"] = UHBoxParam
    aTablevalue[u"横中横框参数.cfg"] = HHBoxParam
    aTablevalue[u"趟门参数.cfg"] = mSlidingParamList
    ...
    aTablevalue[u"中横框参数.cfg"] = mHBoxParamList
    aTablevalue[u"门转换表.cfg"] = cfglist


    mSlidingExp = findName(MBData[u'单门数量类型'], aTablevalue[u'单门数量类型.cfg'])
    ...
    mExp[u'$重叠数'] = mSlidingExp['overlapnum']
    mExp[u'$门扇数'] = mSlidingExp['doornum']
